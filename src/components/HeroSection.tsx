    ...
    >
      <div className="relative flex inset-0 items-center justify-center w-4/5">
        ...
        <div className="relative inset-0 flex flex-col items-center justify-center text-center text-white max-w-5xl px-6 sm:px-8 mx-auto gap-8">
          ...
          <p className="text-base sm:text-lg md:text-lg bg-blue-900/40 rounded-lg leading-relaxed">
          ...
          <div className="flex gap-6 w-full h-12 items-center justify-center">
            <button className="bg-blue-900/40 outline-2 outline-offsset-2 outline-blue-900/40 hover:shadow-[0_0_20px_rgba(0,217,255,0.5)] transition-all cursor-pointer rounded-lg font-medium w-35 h-10 transition duration-200 hover:scale-110">
              Explore Data
            </button>
